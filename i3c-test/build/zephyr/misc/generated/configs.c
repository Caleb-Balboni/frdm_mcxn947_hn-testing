...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARDUCAM_DVP_20PIN_CONNECTOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_CMC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_EHCI_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_EIM_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_ELS_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_ELS_TRNG_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_ERM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_MBOX_MAILBOX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_OPAMP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_SMARTDMA_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_SPC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_USBPHY_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_VBAT_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_VREF_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_WUU_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_FILL_BUFFER_SIZE, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUX_FLASH_K4_API, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CORE_DMA_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SPI2C_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_TEMP_SENSOR_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MCXN_PM_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_FRDM_MCXN947_HN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_FRDM_MCXN947_HN_MCXN947_CPU0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_MCXN, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_DUAL_ROLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_CONTROLLER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_TARGET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_USE_IBI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_IBI_MAX_PAYLOAD_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_IBI_WORKQUEUE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_IBI_WORKQUEUE_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_IBI_WORKQUEUE_PRIORITY, -1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_IBI_WORKQUEUE_LENGTH, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_CONTROLLER_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_INIT_RSTACT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_NUM_OF_DESC_MEM_SLABS, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_I2C_NUM_OF_DESC_MEM_SLABS, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_MCUX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I3C_NXP_TRANSFER_TIMEOUT, 500);
